...
import com.Meta_learning.course.courseservice.requset.CourseUpdateServiceRequest;
...
public class CourseUpdateRequest {
    ...
    @Valid
    private List<CourseDetailUpdateRequest> courseDetails = new ArrayList<>();

    @Builder
    public CourseUpdateRequest(Long courseId, Long courseDescriptId, String courseTitle, String courseDescript, Long coursePrice, String courseCategory, CourseDifficulty courseDifficulty, MultipartFile courseThumbnail, String courseDescriptContent, List<MultipartFile> courseDescriptFiles, CourseStatus courseStatus, List<CourseDetailUpdateRequest> courseDetails) {
    ...
    public CourseDescriptUpdateServiceRequest toCourseDescriptServiceRequest(CourseEntity courseEntity, List<Long> filesToDelete) {
        return CourseDescriptUpdateServiceRequest.builder()
                .courseEntity(courseEntity)
                .courseDescriptContent(courseDescriptContent)
                .filesToDelete(filesToDelete)
                .newFiles(courseDescriptFiles)
                .build();
    }
