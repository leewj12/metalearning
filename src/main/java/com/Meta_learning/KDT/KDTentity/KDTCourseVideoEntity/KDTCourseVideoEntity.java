package com.Meta_learning.KDT.KDTentity.KDTCourseVideoEntity;
...
public class KDTCourseVideoEntity {
    ...
    public void updateVideoDetails(String fileName, String videoUrl, Long size, String type, Long duration) {
        this.kdtCourseVideoFile = fileName;
        this.kdtCourseVideoUUID = videoUrl;
        this.kdtCourseVideoSize = size;
        this.kdtCourseVideoType = type;
        this.kdtCourseVideoTime = duration;
    }

    public void updateKdtCourseVideoTitle(String kdtCourseVideoTitle) {
        this.kdtCourseVideoTitle = kdtCourseVideoTitle;
    }

    public void updateKdtCourseVideoCategory(String kdtCourseVideoCategory) {
