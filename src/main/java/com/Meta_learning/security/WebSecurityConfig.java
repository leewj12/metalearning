...
//                react cors 설정
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/user/**").hasAnyRole("ADMIN", "MANAGER", "INSTRUCTOR", "STUDENT")
                        .requestMatchers("/payment/**").hasAnyRole("ADMIN", "MANAGER", "INSTRUCTOR", "STUDENT")
                        .requestMatchers("/KDT/profileimages/admin/**").hasRole("ADMIN") //어드민 이미지 보는 곳
                        .requestMatchers("/KDT/profileimages/manager/**").hasAnyRole("ADMIN","MANAGER") // 매니저 이미지 보는 곳
                        .requestMatchers("/KDT/profileimages/Instr/**").hasAnyRole("ADMIN","MANAGER","INSTRUCTOR") // 강사 이미지 보는 곳
                        .requestMatchers("/KDT/profileimages/student/**").hasAnyRole("ADMIN","MANAGER","STUDENT") // 학생 이미지 보는 곳
                        .requestMatchers("/KDT/course/**").hasAnyRole("ADMIN","MANAGER","INSTRUCTOR","STUDENT") // 강의자료실
                        .requestMatchers("/course/**").hasAnyRole("ADMIN","INSTRUCTOR","STUDENT") // 강의자료실
