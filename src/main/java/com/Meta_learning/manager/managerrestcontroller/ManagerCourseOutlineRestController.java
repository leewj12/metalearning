...
public class ManagerCourseOutlineRestController {
    ...
    @DeleteMapping("/api/manager/KDT/{kdtSessionId}/courseoutline/delete/{kdtCourseOutlineId}")
...
//            throw new IllegalArgumentException("Cannot delete outline because there are associated videos.");
    ...
    @DeleteMapping("/api/manager/KDT/{kdtSessionId}/courseoutline/{kdtCourseOutlineId}/coursevideo/delete/{kdtCourseVideoId}")
